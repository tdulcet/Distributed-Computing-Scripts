...
expects = ["Join Gimps?", "Use PrimeNet to get work and report results ()",
           "Your user ID or", "Optional computer name", "Type of work to get", 
           "CPU cores to use", "Your choice:", pexpect.TIMEOUT, "Done communicating with server.",
           "Choose Test/Continue to restart"]

responses = ["y", "y", USERID, COMPUTER, TYPE, "", "5", "", "\x03", "5"]
