...
# default. May use the average speed of last 3 calculations to update speed later (see CPU_SPEED variable in gwnum/cpuid.c file)
cpu_speed = "100.0"
...
def get_cuda_ar_object(sendline):
    ...
    #print(ar['error-code'])
    ar['fft-length'] = args[3].strip("n = ").strip("K")
    return ar
